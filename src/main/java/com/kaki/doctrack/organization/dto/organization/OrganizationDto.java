...
public record OrganizationDto(String createdBy, Long createdDate, String lastModifiedBy, Long lastModifiedDate, Long id,
                              ...
                              Set<LocationDto> locations) implements Serializable {

    public static OrganizationDto fromEntity(Organization organization, Set<LocationDto> locations) {
        return new OrganizationDto(organization.getCreatedBy(), organization.getCreatedDate(),
                organization.getLastModifiedBy(), organization.getLastModifiedDate(), organization.getId(),
